      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            Register equipment into the Dunkin&apos; asset
            register.
          </p>
        </div>
      ...
      >
        ...
        <div className="dunkin-card p-6">
          <div className="mb-6">
            ...
            <p className="mt-1 text-sm text-slate-500">
              Basic identification and equipment details.
            </p>
          </div>
        ...
        <div className="dunkin-card p-6">
          <div className="mb-6">
            ...
            <p className="mt-1 text-sm text-slate-500">
              Record installation and warranty dates.
            </p>
          </div>
        ...
        <div className="dunkin-card p-6">
          <div className="mb-6">
            ...
            <p className="mt-1 text-sm text-slate-500">
              Record the latest and upcoming maintenance
              dates.
            </p>
          </div>
